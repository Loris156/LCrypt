...
namespace LCrypt.Utility
{
    public static class PasswordCheck
    {
        private static readonly string[] BadPasswords = {
            ...
            "pookie", "packers", "einstein", "dolphins", "chevy",
            "winston", "warrior", "sammy", "slut", "8675309",
            "zxcvbnm", "nipples", "power", "victoria", "asdfgh",
            "vagina", "toyota", "travis", "hotdog", "paris",
            "rock", "xxxx", "extreme", "redskins", "erotic",
            "dirty", "ford", "freddy", "arsenal", "access14",
            "wolf", "nipple", "iloveyou", "alex", "florida",
            "eric", "legend", "movie", "success", "rosebud",
            "jaguar", "great", "cool", "cooper", "1313",
            "scorpio", "mountain", "madison", "987654", "brazil",
            "lauren", "japan", "naked", "squirt", "stars",
            "apple", "alexis", "aaaa", "bonnie", "peaches",
            "jasmine", "kevin", "matt", "qwertyui", "danielle",
            "beaver", "4321", "4128", "runner", "swimming",
            "dolphin", "gordon", "casper", "stupid", "shit",
            "saturn", "gemini", "apples", "august", "3333",
            "canada", "blazer", "cumming", "hunting", "kitty",
            "rainbow", "112233", "arthur", "cream", "calvin",
            "shaved", "surfer", "samson", "kelly", "paul",
            "mine", "king", "racing", "5555", "eagle",
            "hentai", "newyork", "little", "redwings", "smith",
            "sticky", "cocacola", "animal", "broncos", "private",
            "skippy", "marvin", "blondes", "enjoy", "girl",
            "apollo", "parker", "qwert", "time", "sydney",
            "women", "voodoo", "magnum", "juice", "abgrtyu",
            "777777", "dreams", "maxwell", "music", "rush2112",
            "russia", "scorpion", "rebecca", "tester", "mistress",
        ...
        public static PasswordStrength GetStrength(string password)
        {
            ...
            return (PasswordStrength)score != PasswordStrength.Blank ? (PasswordStrength)score : PasswordStrength.VeryWeak;
        }

        public static string IsCommonPassword(string password)
        {
            foreach (var weakPassword in BadPasswords)
            {
        ...
        private static bool PerformSubstitutions(string weakPassword, string password)
        {
            ...
            return string.Compare(ReplaceLettersWithSubstitutions(weakPassword, qwerty, qwertySubstitution), password, System.StringComparison.OrdinalIgnoreCase) == 0;
        }

        private static string ReplaceLettersWithSubstitutions(string password, IReadOnlyList<char> original, IReadOnlyList<char> substitution)
        {
            ...
            foreach (var c in password)
            {
                ...
                for (var q = 0; q < original.Count; q++)
                {
                    if (c != original[q]) continue;
